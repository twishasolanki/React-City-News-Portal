...
import Bhavngrdynamic from './Bhavngrdynamic.json';

export default function Bhavnagar() {
  return (
    <div>
 <>
      <a href="#" class="block max-w-xlg p-5 bg-white border border-gray-400 rounded-lg shadow hover:bg-gray-120 dark:bg-gray-800 dark:border-gray-600 dark:hover:bg-gray-900 text-center" style={{ marginLeft: "175px", width: '72%' }}>    <div>
        <h3 class="text-3xl font-bold dark:text-white">Bhavnagar</h3></div></a>

{
    Bhavngrdynamic.map((item)=> (
<>
